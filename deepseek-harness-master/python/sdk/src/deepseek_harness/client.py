...
class HarnessClient:
    ...
    def start(self) -> None:
        ...
        # Windows 下宿主为 GUI 进程时，Popen 启动 node 会弹出一个独立控制台黑框。
        # CREATE_NO_WINDOW 配合已有的 stdout/stderr=PIPE 重定向，可静默启动子进程。
    ...
    def next_request(self, timeout: float | None = None) -> IncomingRequest:
